  ...
  public function saveform(){
    ...
    if(isset($_POST['hasil']) and $_POST['hasil'] != ''){
      ...
      if($hasil == 'a'){
        ...
        $txtpersonality = 'Kamu tipe orang yang benar-benar memerhatikan dan menangani bekas luka dengan baik. Buat kamu, bekas luka harus segera ditangani agar cepat memudar dan tidak mengganggu pergaulan dan penampilan terbaikmu. Tentunya, Dermatix adalah pilihan terbaik untuk memudarkan bekas lukamu.';
        $pic = '<img src="'.base_url('assets/frontend/images/hasil/b.png').'" alt="">';
      }elseif ($hasil == 'c') {
        $txtpersonality = 'Kamu tipe yang penuh pertimbangan dan pemilih dalam menangani bekas luka. Padahal, pilih-pilih malah akan bikin kamu banyak pertimbangan dan akhirnya membuatmu ragu, dan akhirnya tidak menghasilkan apa-apa. Jadi, kenapa mesti pilih-pilih kalau sudah ada Dermatix yang telah teruji klinis mampu membantu menyamarkan bekas luka?';
      ...
      echo json_encode(array('status'=>'true','hasil'=>$hasil,'pic'=>$pic,'name'=>$name,'personality'=>$txtpersonality));
    }else{
      echo 'salah';
    }
