          ...
          <div class="form-body">
            ...
            <div class="row">
                ...
                <div class="row margin-bottom-10">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group form-md-line-input form-md-floating-label">
                      ...
                      <label for="form_control_1">Title Banner</label>
                  ...
                  <div class="col-md-12 lebarwidth">
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                      <div class="fileinput-new thumbnail pic-exist">
                        <img src="<?=base_url('assets/images/listbanner/'.$row['pic'])?>" alt=""/>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-4">
                ...
                <div class="noborder">
                  <a href="<?=base_url('webadmin/listbanner')?>" class="btn default">Back to List</a>
                </div>
              </div>
            </div>
          </div>
