...
<html class="no-js" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="http://dermatix.co.id/scarpersonality/assets/frontend/js/vendor/jquery.mCustomScrollbar.min.css" />
  </head>
  <body>
    ...
    <script src="http://dermatix.co.id/scarpersonality/assets/frontend/js/vendor/jquery.mCustomScrollbar.min.js"></script>
    <script>
    $(function() {
