...
<html class="no-js" lang="en">
  ...
  <body>
      ...
      <div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
        ...
        <div class="off-canvas-content" data-off-canvas-content>
          ...
          <section class="container" id="landing">
            ...
            <div class="wrap-txt-landing"><b><i>Ladies</i></b>, mengidentifikasi karakter seseorang juga bisa dilakukan dari caranya merawat bekas luka, lho.<br>Jadi, yuk, cari tahu tipe personality kamu dengan menjawab kuis dari Dermatix berikut.</div>
              ...
              <div class="columns large-6 wrap-tanya bg-corp">
                <div class="row" style="margin:40px 0">
                  ...
                  <div class="medium-12 columns item-pita item-choice" data-option="d">
                    <div class="pita-tanya color-corp">d. Luka karena kulit gatal yg disebabkan alergi/digigit serangga</div>
                  </div>
          ...
          <section class="pertanyaan" id="tanya-5" data-tanya="5">
            <div class="large-12">
              <div class="columns large-6 wrap-tanya">
                <div class="tanya-kiri">
                  <div class="wrap-pertanyaan">
                    ...
                    <div class="txt-tanya" style="padding-top:17px">DARI DAFTAR KELEBIHAN OBAT PEMUDAR LUKA<br>DI BAWAH INI, MANA YANG AKAN KAMU UTAMAKAN?</div>
                  </div>
                  <div class="wrap-dot">
                    <ul>
                      <li class="bg-done"></li>
              ...
              <div class="columns large-6 wrap-tanya bg-corp">
                <div class="row" style="margin:40px 0">
                  <div class="medium-12 columns item-pita item-choice" data-option="a">
                    <div class="pita-tanya color-corp"> a. Obat pemudar luka yang tidak  lengket di kulit.</div>
                  </div>
                  <div class="medium-12 columns item-pita item-choice" data-option="b">
                    <div class="pita-tanya color-corp">b. Obat pemudar luka yang cocok untuk kulit sensitif.</div>
                  </div>
                  <div class="medium-12 columns item-pita item-choice" data-option="c">
                    <div class="pita-tanya color-corp">c. Tidak ada yang spesifik; asal dapat memudarkan luka.</div>
                  </div>
                  <div class="medium-12 columns item-pita item-choice" data-option="d">
                    <div class="pita-tanya color-corp">d. Obat yang teruji klinis.</div>
                  </div>
                  <div class="medium-12 columns item-pita item-choice" data-option="e">
                    <div class="pita-tanya color-corp">e. Obat pemudar luka dengan merek terkenal</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="large-12">
              ...
              <div class="columns large-6 wrap-tanya bg-corp">
                <div class="row" style="margin:40px 0">
                  <div class="medium-12 columns item-pita item-choice" data-option="a">
                    <div class="pita-tanya2 white-color">
                     a. Tidak mempermasalahkan, terutama jika hanya luka kecil.
                     <div class="pita-vector-kiri"></div>
                     <div class="pita-vector-kanan"></div>
                    </div>
                  </div>
              ...
              <div class="columns large-6 wrap-tanya">
                <div class="tanya-kiri">
                  <div class="wrap-pertanyaan">
                    ...
                    <div class="txt-tanya" style="padding-top:17px">DI BAWAH INI, MANA YANG AKAN<br>KAMU LAKUKAN UNTUK MEMUDARKAN BEKAS LUKA?</div>
                  </div>
                  <div class="wrap-dot">
                    <ul>
                      <li class="bg-done"></li>
          ...
          <section class="container" id="result">
            <div class="wrap-result">
              ...
              <form action="" id="form-submit">
                ...
                <div id='btn-result'>CEK RESULT<br><img src="<?=base_url('assets/frontend/images/panah-submit.png')?>" alt=""></div>
              </form>
            </div>
          </section>
          <section class="container wrap-scroll" id="personality">
            <div id="wrap-personality">
              <div class="txt-atas">
                Hi <span class="txtnama"></span> !<br>Kamu adalah type personality ...
              </div>
              <div class="pic-personality">
                <img src="<?=base_url('assets/frontend/images/hasil/a.png')?>" alt="">
              </div>
              <div class="wrap-txt-hasil">
              ...
              <div class="wrap-share">
                Share your result
                <div class="wrap-icon">
                  <a href="#"><img src="<?=base_url('assets/frontend/images/icon-fb.png')?>" alt=""></a>
                  <a href="#"><img src="<?=base_url('assets/frontend/images/icon-twit.png')?>" alt=""></a>
                </div>
              </div>
            </div>
          </section>
    ...
    <script src="https://raw.githubusercontent.com/malihu/malihu-custom-scrollbar-plugin/master/js/minified/jquery.mCustomScrollbar.min.js"></script>
    <script>
    $(function() {
