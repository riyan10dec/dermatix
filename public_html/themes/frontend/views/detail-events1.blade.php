...
Theme::breadcrumb()
        ...
        ->add('Press Conference', URL::to('press-conference'));
?>
<section id="detail-up-events">
    <header class="page-header">
        <div class="container">
            <h1 class="title">Press Conference : The 17th Annual Scientific Meeting of Indonesia</h1>
        </div>
    </header>
    <div class="container">
        <div class="row">
                    ...
                    <div class="col-xs-12">
                        <ul>
                            <li>
                                ...
                                <span id="desc-liChangeMobile_place"  class="desc-li width75">Grand Melia Hotel (Jakarta)</span>
                            </li>
                        </ul>
                    </div>
                </div>
                <img src="{{ URL::to('uploads/events/Press-Conference a.jpg') }}" alt="" class="img-responsive">
            </div>
