<link rel="stylesheet" type="text/css" href="<?=base_url('assets/global/plugins/jquery-nestable/jquery.nestable_single.css')?>"/>
<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
Landing Page Picture List <small><br>Drag & drop list with mouse and touch compatibility</small>
</h3>
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<div class="row">
  <div class="col-md-12 margin-bottom-20">
    ...
    <a class="btn btn-lg blue" href="<?=base_url('webadmin/landing/act/add')?>">
  ...
  <div class="col-md-12">
    <div class="portlet box">
      <div class="portlet-body wrap-menu-nestable">
        ...
        if ($jumlahdata != 0) {
        ?>
        <div class="dd" <?=($statuspage == 'publish' and $permit->isupdate == 1) ? 'id="nestable_list_1"' : '' ;?> lang="landing">
          <ol class="dd-list">
          <?php
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <a href="<?=base_url('webadmin/landing/act/'.$fungsidelete.'/'.$row['id'])?>" class="btn btn-danger">Yes</a>
          ...
          <div class="modal fade draggable-modal" id="draft<?=$row['id']?>" tabindex="-1" role="basic" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <a href="<?=base_url('webadmin/landing/act/'.$fungsiupdate.'/'.$row['id'])?>" class="btn btn-danger">Yes</a>
                  <button type="button" class="btn default" data-dismiss="modal">Close</button>
                </div>
              </div>
              <!-- /.modal-content -->
              ...
              <div class="dd3-content">
                <div class="<?=$cssclass?>">
                  ...
                  <div class="wrap-img-nestable">
                    <img src="<?=base_url('assets/images/landing/'.$row['thumb'])?>" alt="">  
                  </div>
                </div>
                <div class="link-menu">
                  <?php
                  ...
                  <a href="<?=base_url('webadmin/landing/act/restore/'.$row['id'])?>">Restore to Draft</a>
                  <a data-toggle="modal" style="color:red" href="#draggable<?=$row['id']?>">Delete Permanently</a>
                  <?php else: ?>
                  <a href="<?=base_url('webadmin/landing/act/view/'.$row['id'])?>">View</a>
                  <?php endif ?>
                  <?php
                  } elseif ($statuspage == 'draft'){
                  ?>
                  <?php if ($permit->isupdate == 1): ?>
                  <a href="<?=base_url('webadmin/landing/act/edit/'.$row['id'])?>">Edit</a>
                ...
                ?>
                  ...
                  <div class="modal fade draggable-modal" id="draggable<?=$row2['id']?>" tabindex="-1" role="basic" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <a href="<?=base_url('webadmin/landing/act/trash/'.$row2['id'])?>" class="btn btn-danger">Yes</a>
                          <button type="button" class="btn default" data-dismiss="modal">Close</button>
                        </div>
                      </div>
                      <!-- /.modal-content -->
                  ...
                  <li class="dd-item dd3-item" data-id="<?=$row2['id']?>">
                    ...
                    <div class="dd3-content">
                      ...
                      <div class="link-menu">
                        <?php if ($permit->isupdate == 1): ?>
                        <a href="<?=base_url('webadmin/landing/act/edit/'.$row2['id'])?>">Edit</a>
                        <?php endif ?>
                        <?php if ($permit->isdelete == 1): ?>
...
<script src="<?=base_url('assets/global/plugins/jquery-nestable/jquery.nestable_single.js')?>"></script>
