            ...
            <div class="row">
              <div class="col-md-10">
                                ...
                                <td>
                                  <div class="md-checkbox-inline checkbox-table">
                                    <div class="md-checkbox has-success">
                                      <input type="checkbox"
                                      <?php
                                        $ischeck = strpos($accview, $row2['id']); 
                                        if ($ischeck !== false) {
                                          $check = "checked";
                                        }else{
                                          $check = "";
                                    ...
                                    <div class="md-checkbox has-info">
                                      <input type="checkbox"
                                      <?php
                                        $ischeckadd = strpos($accadd, $row2['id']); 
                                        if ($ischeckadd !== false) {
                                          $check = "checked";
                                        }else{
                                          $check = "";
                                    ...
                                    <div class="md-checkbox has-info">
                                      <input type="checkbox"
                                      <?php
                                        $ischeckupdate = strpos($accupdate, $row2['id']); 
                                    ...
                                    <div class="md-checkbox has-error">
                                      <input type="checkbox"
                                      <?php
                                        $ischeckdelete = strpos($accdelete, $row2['id']); 
                ...
                <div class="form-actions noborder margin-top-20">
                  ...
                  <a href="<?=base_url('webadmin/divisi')?>" class="btn default">Cancel</a>
                </div>
              </div>
            </div>
          </div>
