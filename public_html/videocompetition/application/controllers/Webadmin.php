...
class Webadmin extends CI_Controller {
  ...
  public function login(){
    ...
    if ($data['statuslogin'] == 1) {
      redirect('index.php/webadmin', 'refresh');
      die();
    }
  ...
  function do_login(){
    ...
    if (isset($username) AND $username != '' AND isset($password) AND $password != ''){
      ...
      if ($result == 1){
        ...
        redirect('index.php/webadmin/login', 'refresh');
      }
    }else{
      redirect('index.php/webadmin/login', 'refresh');
    }
        ...
        if ($this->segs[4] == 'add'){
          ...
          if (isset($this->segs[5]) AND $this->segs[5] != '' AND is_numeric($this->segs[5])) {
            ...
            if ($data_rec) {
              ...
              redirect('index.php/webadmin/menu', 'refresh');
            }
          ...
          if (isset($this->segs[5]) AND $this->segs[5] != '') {
            ...
            if ($deleted){
              ...
              redirect('index.php/webadmin/menu/trash', 'refresh');
        ...
        if ($this->segs[4] == 'add'){
          ...
          if (isset($this->segs[5]) AND $this->segs[5] != '' AND is_numeric($this->segs[5])) {
            ...
            if ($data_divisi) {
              ...
              redirect('index.php/webadmin/divisi', 'refresh');
            }
          ...
          if (isset($this->segs[5]) AND $this->segs[5] != '') {
            ...
            if ($deleted){
              ...
              redirect('index.php/webadmin/divisi/trash', 'refresh');
        ...
        if ($this->segs[4] == 'add'){
          ...
          if (isset($this->segs[5]) AND $this->segs[5] != '' AND is_numeric($this->segs[5])) {
            ...
            if ($data_user) {
              ...
              redirect('index.php/webadmin/user', 'refresh');
            }
          ...
          if (isset($this->segs[5]) AND $this->segs[5] != '') {
            ...
            if ($deleted){
              ...
              redirect('index.php/webadmin/user/trash', 'refresh');
  ...
  public function video(){       
    ...
    if (isset($this->segs[3]) AND $this->segs[3] == 'act'){           
      ...
      if (isset($this->segs[4])){
        ...
        if ($this->segs[4] == 'tampil'){
          ...
          if ($hide){
            ...
            redirect('index.php/webadmin/video', 'refresh');
      ...
      $data_rec = $this->db->query('SELECT id,name,email,telp,judul,status,link,namefile,cretime FROM video order by cretime DESC')->result_array();  

      $data_count = $this->db->query('SELECT count(*) as jumlah FROM `video` order by cretime asc')->result();        
      ...
      if (isset($this->segs[4])){
        ...
        if ($this->segs[4] == 'add'){
          ...
          if (isset($this->segs[5]) AND $this->segs[5] != '' AND is_numeric($this->segs[5])) {
            ...
            //   $data['row'] = $data_row[0];
            // } else {
            //   redirect('index.php/webadmin/homepage', 'refresh');
            // }
        ...
        if ($this->segs[4] == 'add'){
          ...
          if (isset($this->segs[5]) AND $this->segs[5] != '' AND is_numeric($this->segs[5])) {
            ...
            if ($data_row) {
              ...
              redirect('index.php/webadmin/clients', 'refresh');
            }
