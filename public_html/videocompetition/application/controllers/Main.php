...
class Main extends CI_Controller {
  ...
  public function index(){
    ...
    $data['rec'] = $this->db->query('SELECT name,link,namefile,judul,deskripsi FROM `video` where status = 1 ORDER BY cretime desc')->result_array();
  ...
  function savevideo(){
    ...
    if (isset($_FILES['video']['name']) && $_FILES['video']['name'] != '') {
        ...
        $configVideo['allowed_types'] = 'avi|mov|flv|wmv|mp3|mp4';
